...
four = link(4, link(3, link(2, link(1, empty))))
print(first(four))
print(rest(four))
...
def gititem_link(s, i):
    """
    Return the element at index of linked list s.
    """
    while i>0:
        s, i = rest(s), i-1
    return first(s)
...
def gititem_link_recursive(s, i):
    """
    Return the element at index i of linked list s.
    """    
    if i == 0:
        return first(s)
    return gititem_link_recursive(rest(s), i-1)
